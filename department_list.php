  ...
  <table id="example1" class="table table-bordered table-striped dataTable">
    <thead>
      <tr role="row" class="info">
        ...
        <th  tabindex="0" rowspan="1" colspan="1" style="width: 85%;">ชื่อหลักสูตร</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>         
          <a class="btn btn-danger btn-flat btn-sm" href="department_del.php?d_id=<?php echo $row_dm['d_id']; ?>" 
